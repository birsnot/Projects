...
for i =0:10
    ...
    annotation(topView,'ellipse',[tcx-0.02 tcy-0.02*450/400 0.04 0.04*450/400]...
...
uicontrol(h,'Style','text','String','Angle from the ground in degree', ...
...
xc = 0.25;  yc=yc-0.075;  wt=0.25; ht=0.075;
uicontrol(h,'Style','text','String','Angle from +X axis in degree', ...
    'FontWeight','bold','FontSize',9, ...
    'Units','normalized','Position',[xc yc wt+0.002 ht]);
