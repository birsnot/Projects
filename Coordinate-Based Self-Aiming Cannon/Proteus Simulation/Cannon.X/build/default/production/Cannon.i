...
char keypad_scanner(void){
    while(1){
     PORTBbits.RB4 = 1; PORTBbits.RB5 = 0; PORTBbits.RB6 = 0;
            if (PORTBbits.RB0 == 1) {while (PORTBbits.RB0 == 1);return '1';}
            if (PORTBbits.RB1 == 1) {while (PORTBbits.RB1 == 1);return '4';}
            if (PORTBbits.RB2 == 1) {while (PORTBbits.RB2 == 1);return '7';}
            if (PORTBbits.RB3 == 1) {while (PORTBbits.RB3 == 1);return '.';}
     PORTBbits.RB4 = 0; PORTBbits.RB5 = 1;
            if (PORTBbits.RB0 == 1) {while (PORTBbits.RB0 == 1);return '2';}
            if (PORTBbits.RB1 == 1) {while (PORTBbits.RB1 == 1);return '5';}
            if (PORTBbits.RB2 == 1) {while (PORTBbits.RB2 == 1);return '8';}
            if (PORTBbits.RB3 == 1) {while (PORTBbits.RB3 == 1);return '0';}
     PORTBbits.RB5 = 0; PORTBbits.RB6 = 1;
            if (PORTBbits.RB0 == 1) {while (PORTBbits.RB0 == 1);return '3';}
            if (PORTBbits.RB1 == 1) {while (PORTBbits.RB1 == 1);return '6';}
            if (PORTBbits.RB2 == 1) {while (PORTBbits.RB2 == 1);return '9';}
            if (PORTBbits.RB3 == 1) {while (PORTBbits.RB3 == 1);return 'E';}
    }}
...
unsigned int dcCalcT(float x,float y){
    ...
    float rng2 = rng*rng;
    float rng3 = rng*rng2;
    rng = 3.9939*rng3-4.7126*rng2 + 2.5891*rng + 0.0915;
    rng2 = rng*rng;
    rng3 = rng*rng2;
    rng = -43.5426*rng3 + 72.3475*rng2 - 3.9841*rng - 0.2815;
    dc = rng*1116.6667;
    return dc;
}
